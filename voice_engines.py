...
SPOKEN_COMMANDS = (
    ...
    "the dictation and leave the command itself out of the output. Look for commands first "
    "at the very beginning, before the message («переведи на английский: …»), and at the "
    "very end, after it («…увидимся завтра в десять. Переведи на английский») — that is "
    "where they almost always are. A phrase in the middle is most likely part of the "
    "message; take it as a command only when it is clearly addressed to you rather than "
    "to the reader. Wherever it stands, a phrase is a command only when it tells you how "
    "to render this text; when it is part of what the user is saying to someone else "
