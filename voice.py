...
VSTR = {
    ...
    "press_combo": {"en": "Press a key or a combination\n\nEsc — cancel", "ru": "Нажми клавишу или сочетание\n\nEsc — отмена", "es": "Pulsa una tecla o combinación\n\nEsc — cancelar", "pt": "Pressione uma tecla ou combinação\n\nEsc — cancelar", "de": "Taste oder Kombination drücken\n\nEsc — Abbrechen", "fr": "Appuie sur une touche ou une combinaison\n\nÉchap — annuler", "zh": "按下一个键或组合键\n\nEsc — 取消"},
    ...
    "hk_single_note": {"en": "Hold it and talk. Together with another key it works as usual (Alt+Tab, Alt+Shift, Ctrl+C…) and no recording starts.", "ru": "Держишь — идёт запись. Вместе с другой клавишей работает как обычно (Alt+Tab, Alt+Shift, Ctrl+C…), запись не начинается.", "es": "Mantenla pulsada y habla. Junto con otra tecla funciona como siempre (Alt+Tab, Alt+Shift, Ctrl+C…) y no graba.", "pt": "Segure e fale. Junto com outra tecla funciona normalmente (Alt+Tab, Alt+Shift, Ctrl+C…) e não grava.", "de": "Gedrückt halten und sprechen. Zusammen mit einer anderen Taste wirkt sie wie gewohnt (Alt+Tab, Alt+Umschalt, Strg+C…), es wird nicht aufgenommen.", "fr": "Maintiens-la et parle. Avec une autre touche elle fonctionne normalement (Alt+Tab, Alt+Maj, Ctrl+C…), sans enregistrement.", "zh": "按住即录音。与其他键一起按时照常工作（Alt+Tab、Alt+Shift、Ctrl+C…），不会开始录音。"},
...
DEFAULTS = {
    "enabled": True,
    "hk_mods": 0, "hk_vk": vs.VK_LMENU, "mode": "hold",
    "mic": "",
...
class VoiceController:
    ...
    def register_hotkey(self):
        ...
        self.hook.mask_taps = self.get("mode") == "toggle"
        self.hook.arm_delay = self.ARM_DELAY
